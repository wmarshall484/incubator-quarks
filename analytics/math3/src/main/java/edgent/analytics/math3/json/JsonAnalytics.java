...
under the License.
*/
package edgent.analytics.math3.json;
...
import edgent.function.ToDoubleFunction;
...
public class JsonAnalytics {
     ...
     * <P>
     * This is a multi-variable analog of {@link JsonAnalytics#aggregateList(String, String, edgent.function.ToDoubleFunction, JsonUnivariateAggregate...) aggregateList()}
     * <P>
