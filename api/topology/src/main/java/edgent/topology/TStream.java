 ...
 * is {@link edgent.execution.Submitter#submit(Object) submitted}
 * to a runtime.
 * 
 * </P>
 * @param <T>
...
public interface TStream<T> extends TopologyElement {
     ...
     * {@link edgent.execution.services.RuntimeServices runtime services}.
     * 
     ...
     * <P>
     * To create a window partitioned using the tuple as the key use {@link edgent.function.Functions#identity() identity()}
     * as the key function.
     * </P>
     * <P>
     * To create an unpartitioned window use a key function that returns a constant,
     * by convention {@link edgent.function.Functions#unpartitioned() unpartitioned()} is recommended.
     * </P>
     * 
     * @param <K> Key type.
     * 
