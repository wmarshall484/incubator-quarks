 ...
 * {@linkplain edgent.topology.services.ApplicationService Application service}
 ...
 * {@link edgent.topology.mbeans.ApplicationServiceMXBean}
 * to provide control of the service.
 *  
 * <h4 id="submitApp">Submit an Application</h4>
 * Method: {@link edgent.topology.mbeans.ApplicationServiceMXBean#submit(String, String)}
 ...
 *  </tr>
 * <tr>
 *    <td headers="attrName">{@link edgent.runtime.jsoncontrol.JsonControlService#TYPE_KEY type}</td>
 *    <td headers="type">String</td>
 *    <td headers="value">{@link edgent.topology.mbeans.ApplicationServiceMXBean#TYPE appService}</td>
 *    <td headers="desc">{@code ApplicationServiceMXBean} control MBean type.</td>
 *  </tr>
 *  <tr>
 *    <td headers="attrName">{@link edgent.runtime.jsoncontrol.JsonControlService#OP_KEY op}</td>
 *    <td headers="type">String</td>
 *    <td headers="value">{@code submit}</td>
 *    <td headers="desc">Invoke {@link edgent.topology.mbeans.ApplicationServiceMXBean#submit(String, String) submit} operation
 *    against the control MBean.</td>
 *  </tr>
 *  <tr>
 *    <td headers="attrName">{@link edgent.runtime.jsoncontrol.JsonControlService#ALIAS_KEY alias}</td>
 *    <td headers="type">String</td>
 *    <td headers="value">Alias of control MBean.</td>
 *    <td headers="desc">Default is {@link edgent.topology.services.ApplicationService#ALIAS edgent}.</td>
 *  </tr>
 *  <tr>
 *    <td rowspan="2" headers="attrName">{@link edgent.runtime.jsoncontrol.JsonControlService#ARGS_KEY args}</td>
 ...
 *    see {@link edgent.execution.Submitter#submit(Object, com.google.gson.JsonObject) submit()}.
 ...
 */
package edgent.topology.mbeans;
