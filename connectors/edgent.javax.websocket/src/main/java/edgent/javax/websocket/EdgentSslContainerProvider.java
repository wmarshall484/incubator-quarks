...
under the License.
*/
package edgent.javax.websocket;
...
public abstract class EdgentSslContainerProvider {
     ...
     * of {@code edgent.javax.websocket.Edgent.SslContainerProvider}.
     * @param config  SSL configuration info as described by
     * {@code edgent.containers.wsclient.javax.websocket.Jsr356WebSocketClient}.
