...
under the License.
*/
package edgent.connectors.mqtt;

import java.nio.charset.StandardCharsets;

import edgent.connectors.mqtt.runtime.MqttConnector;
import edgent.connectors.mqtt.runtime.MqttPublisher;
import edgent.connectors.mqtt.runtime.MqttSubscriber;
...
public class MqttStreams {
    ...
    /**
     * Get the {@link edgent.topology.Topology} the connector is associated with.
     * @return the value
     */
