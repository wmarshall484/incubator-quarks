...
under the License.
*/
package edgent.connectors.pubsub.service;
 ...
 * then {@link edgent.connectors.pubsub.PublishSubscribe#publish(edgent.topology.TStream, String, Class) publish}
 * is a no-op, a sink that discards all tuples on the stream.
 * <BR>
 * A {@link edgent.connectors.pubsub.PublishSubscribe#subscribe(edgent.topology.TopologyElement, String, Class) subscribe} 
 ...
 * @see edgent.connectors.pubsub.PublishSubscribe#subscribe(edgent.topology.TopologyElement, String, Class)
 */
