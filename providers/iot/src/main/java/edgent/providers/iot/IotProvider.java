...
import edgent.connectors.iot.Commands;
 ...
 * {@link edgent.connectors.pubsub.PublishSubscribe Publish-subscribe} is
 ...
 * {@code IotDevice} using {@link IotDevicePubSub#addIotDevice(edgent.topology.TopologyElement)}</LI>
...
public class IotProvider implements TopologyProvider,
 DirectSubmitter<Topology, Job> {
     ...
     * in {@code IotDevice} is created using {@link IotDevicePubSub#addIotDevice(edgent.topology.TopologyElement)}.
     * <BR>
     * Note that {@code builder} obtains a reference to its topology using
     * {@link IotDevice#topology()}.
     * <P>
     * When the application is
     * {@link edgent.topology.mbeans.ApplicationServiceMXBean#submit(String, String) submitted} {@code builder.accept(iotDevice, config)}
