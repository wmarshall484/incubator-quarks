 ...
 * </p>
 * <UL>
 * <LI>{@link TStream#filter(edgent.function.Predicate)}</LI>
 * <LI>{@link TStream#map(edgent.function.Function)}</LI>
 * <LI>{@link TStream#sink(edgent.function.Consumer)}
 * </UL>
