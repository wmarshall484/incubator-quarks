...
import static edgent.function.Functions.synchronizedFunction;
import static edgent.window.Policies.alwaysInsert;
import static edgent.window.Policies.evictOlderWithProcess;
import static edgent.window.Policies.insertionTimeList;
import static edgent.window.Policies.scheduleEvictIfEmpty;
...
import edgent.oplet.core.Union;
import edgent.oplet.functional.Filter;
import edgent.oplet.functional.FlatMap;
import edgent.oplet.functional.Map;
import edgent.oplet.functional.Peek;
import edgent.oplet.window.Aggregate;
import edgent.topology.TSink;
import edgent.topology.TStream;
import edgent.topology.TWindow;
import edgent.topology.Topology;
import edgent.topology.spi.AbstractTStream;
