...
//    }
     ...
     * @see edgent.graph.Graph#peekAll(edgent.function.Supplier, edgent.function.Predicate) Graph.peekAll()
     */
    public static void addStreamScopes(Topology t) {
      ...
      t.graph().peekAll( 
          () -> { return new edgent.streamscope.oplets.StreamScope<>(new StreamScope<>()); },
